...
export default function ProductModal({ product, onClose }: Props) {
  ...
  return (
    <>
      ...
      >
        <div
          className="w-full max-w-2xl max-h-[92vh] overflow-y-auto rounded-2xl flex flex-col pointer-events-auto"
          style={{ background: "hsl(240 6% 7%)", border: "1px solid rgba(201,146,26,0.3)", boxShadow: "0 25px 60px rgba(0,0,0,0.7)" }}
              ...
              <div className="flex flex-col md:flex-row gap-0">
                ...
                <div className="md:w-5/12 shrink-0">
                  <div className="relative w-full" style={{ paddingTop: "100%" }}>
                    <img
                      src={imgError ? "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600&q=80" : product.image}
                      alt={product.name}
                ...
                <div className="flex-1 p-6 flex flex-col gap-4">
                  <div>
                    <h2 className="text-2xl font-black leading-snug mb-2" style={{ color: "#f0ead6" }}>
                      {product.name}
                    </h2>
                  ...
                  <div className="flex flex-col gap-2 text-sm">
                    {[
                      ...
                      <div key={item.text} className="flex items-center gap-2" style={{ color: "rgba(240,234,214,0.6)" }}>
                        <span>{item.icon}</span>
                        <span>{item.text}</span>
                      </div>
                    ))}
                  ...
                  <div className="flex gap-3 mt-auto pt-2">
                    <button
                      ...
                      className="flex-1 py-3 rounded-xl font-black text-base flex items-center justify-center gap-2"
                    ...
                    <button
                      ...
                      className="px-4 py-3 rounded-xl font-bold flex items-center gap-1.5 text-sm transition-all"
                      style={
                        addedToCart
                  ...
                  {formError && (
                    <p className="text-xs text-center -mt-2" style={{ color: "#ef4444" }}>{formError}</p>
                  )}
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div className="p-6 flex flex-col gap-5">
                ...
                <div className="flex gap-4 p-4 rounded-xl"
                  ...
                  <img
                    src={imgError ? "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=200" : product.image}
                    alt={product.name}
                ...
                <div className="flex items-center gap-2 text-xs" style={{ color: "rgba(240,234,214,0.4)" }}>
                  ...
                  <div className="flex-1 h-px mx-1" style={{ background: "rgba(201,146,26,0.2)" }} />
                  <span className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold"
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs font-semibold" style={{ color: "#c9921a" }}>الحي / الشارع</label>
                      <input
                        type="text"
                        placeholder="اختياري"
                ...
                <button
                  ...
                  className="w-full py-4 rounded-xl font-black text-base flex items-center justify-center gap-2 mt-1"
